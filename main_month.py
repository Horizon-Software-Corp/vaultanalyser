...
if not cache_used or True:
    ...
    for vault in vaults:
        ...
        if details and "portfolio" in details:
            if details["portfolio"][2][0] == "month":
                sampling_days = 1
                ...
                metrics = {
                    ...
                    "Daily Sharpe Ratio": ret.mean() / ret.std(),
                    "Daily Sortino Ratio": (
                ...
                reliability_metrics = calculate_sharpe_reliability(
                    ret.values, h=8, SR0=0.1, LT=None  # monthlyは30本しかない
                )
...
sliders = [
    ...
    {
        "label": "Min Daily Sharpe Ratio",
        "column": "Daily Sharpe Ratio",
        "max": False,
        "default": 0.1,
        "step": 0.05,
    },
    {
        "label": "Min Daily Sortino Ratio",
        "column": "Daily Sortino Ratio",
        "max": False,
        "default": 0.1,
        "step": 0.05,
    },
